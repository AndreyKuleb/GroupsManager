...
/**
 * Provides the local service utility for TraccarGroup. This utility wraps
 * {@link com.bmstu.groups.manager.core.service.impl.TraccarGroupLocalServiceImpl} and is the
 ...
 */
@ProviderType
public class TraccarGroupLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.bmstu.groups.manager.core.service.impl.TraccarGroupLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.bmstu.groups.manager.core.model.TraccarGroup addTraccarGroup(
		com.bmstu.groups.manager.core.model.TraccarGroup traccarGroup) {
		return getService().addTraccarGroup(traccarGroup);
	}
	...
	public static com.bmstu.groups.manager.core.model.TraccarGroup addTraccarGroup(
		...
		return getService()
				   .addTraccarGroup(userId, name, traccarGroupAttributes,
			serviceContext);
	}
	...
	*/
	public static com.bmstu.groups.manager.core.model.TraccarGroup createTraccarGroup(
		long traccarGroupId) {
		return getService().createTraccarGroup(traccarGroupId);
	}
	...
	*/
	public static com.bmstu.groups.manager.core.model.TraccarGroup deleteTraccarGroup(
		com.bmstu.groups.manager.core.model.TraccarGroup traccarGroup) {
		return getService().deleteTraccarGroup(traccarGroup);
	}
	...
	*/
	public static com.bmstu.groups.manager.core.model.TraccarGroup deleteTraccarGroup(
		long traccarGroupId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleteTraccarGroup(traccarGroupId);
	}

	public static com.bmstu.groups.manager.core.model.TraccarGroup fetchTraccarGroup(
		long traccarGroupId) {
		return getService().fetchTraccarGroup(traccarGroupId);
	}
	...
	*/
	public static com.bmstu.groups.manager.core.model.TraccarGroup fetchTraccarGroupByUuidAndGroupId(
		java.lang.String uuid, long groupId) {
		return getService().fetchTraccarGroupByUuidAndGroupId(uuid, groupId);
	}
	...
	* @throws PortalException if a traccar group with the primary key could not be found
	*/
	public static com.bmstu.groups.manager.core.model.TraccarGroup getTraccarGroup(
		long traccarGroupId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getTraccarGroup(traccarGroupId);
	}
	...
	*/
	public static com.bmstu.groups.manager.core.model.TraccarGroup getTraccarGroupByUuidAndGroupId(
		java.lang.String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getTraccarGroupByUuidAndGroupId(uuid, groupId);
	}
	...
	*/
	public static com.bmstu.groups.manager.core.model.TraccarGroup updateTraccarGroup(
		com.bmstu.groups.manager.core.model.TraccarGroup traccarGroup) {
		return getService().updateTraccarGroup(traccarGroup);
	}
	...
	*/
	public static int getTraccarGroupsCount() {
		return getService().getTraccarGroupsCount();
	}
	...
	*/
	public static java.util.List<com.bmstu.groups.manager.core.model.TraccarGroup> getTraccarGroups(
		int start, int end) {
		return getService().getTraccarGroups(start, end);
	}

	public static java.util.List<com.bmstu.groups.manager.core.model.TraccarGroup> getTraccarGroups(
		long groupId, int start, int end) {
		return getService().getTraccarGroups(groupId, start, end);
	}
	...
	*/
	public static java.util.List<com.bmstu.groups.manager.core.model.TraccarGroup> getTraccarGroupsByUuidAndCompanyId(
		java.lang.String uuid, long companyId) {
		return getService().getTraccarGroupsByUuidAndCompanyId(uuid, companyId);
	}
	...
	*/
	public static java.util.List<com.bmstu.groups.manager.core.model.TraccarGroup> getTraccarGroupsByUuidAndCompanyId(
		...
		return getService()
				   .getTraccarGroupsByUuidAndCompanyId(uuid, companyId, start,
	...
	*/
	...
	public static TraccarGroupLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<TraccarGroupLocalService, TraccarGroupLocalService> _serviceTracker =
		ServiceTrackerFactory.open(TraccarGroupLocalService.class);
}